...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtilityKeepAlive_v1.5.exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtilityKeepAlive_v1.5(x64).exe
#AutoIt3Wrapper_Res_Comment=By Phoenix125
#AutoIt3Wrapper_Res_Description=AtlasServerUpdateUtilityKeepAlive_v1.5
#AutoIt3Wrapper_Res_Fileversion=1.5.0.0
#AutoIt3Wrapper_Res_ProductName=AtlasServerUpdateUtilityKeepAlive_v1.5
...
Global $iTrayLastUpdated = TrayCreateItem("Last Online Time: [Waiting 2 minutes]")
TrayCreateItem("")
...
TrayItemSetText($iTrayLastUpdated, "Last Online Time: [Waiting " & 120 - $i & " more seconds]")
Sleep(1000)
Next
Func GetPID()
...
If $aPauseUtil = True Then Tray_ResumeUtil()
$aPauseUtil = False
Else
If $aPauseUtil = False Then Tray_PauseUtil()
$aPauseUtil = True
EndIf
...
RunWait(@ScriptDir & "\AtlasServerUpdateUtilityKeepAlive.bat")
SplashTextOn($aUtilName, "WARNING! " & @CRLF & GetFileFromFullPath($aProgramToRun) & @CRLF & " unresponsive or closed unexpectedly. Restarting program.", 600, 140, -1, -1, $DLG_MOVEABLE, "")
Else
If $aStartMinimizedYN = "no" Then
$aPID = Run($aProgramToRun, @ScriptDir)
